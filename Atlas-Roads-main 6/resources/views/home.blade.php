                    ...
                    <div class="introduce">
                        ...
                        <div class="topic">
                            @if($carouselBook->category_id && $carouselBook->relationLoaded('category'))
                                @php $cat = $carouselBook->getRelation('category'); @endphp
                                {{ $cat ? $cat->category_name : 'N/A' }}
                            @else
                                {{ $carouselBook->getAttribute('category') ?? 'N/A' }}
                            @endif
                        </div>
                        <div class="des">
                            Discover this book published in {{ $carouselBook->published_year }} in the 
                            @if($carouselBook->category_id && $carouselBook->relationLoaded('category'))
                                @php $cat = $carouselBook->getRelation('category'); @endphp
                                {{ $cat ? $cat->category_name : 'N/A' }}
                            @else
