    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-800 mb-2">Schedule New Meeting</h1>
                <p class="text-gray-600">Create a meeting for <span class="font-semibold text-blue-600">{{ $club->name }}</span></p>
                <div class="mt-4 flex justify-center gap-3">
                    <a href="{{ route('clubs.show', $club) }}" class="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-2">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form method="POST" action="{{ route('clubs.meetings.store', $club) }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="agenda" rows="4" 
                                  ...
                                  placeholder="What will be discussed in this meeting?">{{ old('agenda') }}</textarea>
                    </div>
