<div>
    <div class="p-6 bg-white rounded shadow">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('community.create') }}" class="px-4 py-2 inline-flex items-center gap-2 rounded shadow" style="background-color:#2563eb;color:#ffffff;z-index:60;border:1px solid rgba(0,0,0,0.05);"> 
                        ...
                        @foreach($communities as $community)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 text-right">
                                        <a href="{{ route('communities.show', $community) }}" class="px-3 py-1 inline-flex items-center text-sm mr-2 rounded" style="background-color:#ffffff;color:#111827;border:1px solid rgba(0,0,0,0.06);box-shadow:0 1px 2px rgba(0,0,0,0.04);">
                                        <i class="fas fa-eye mr-1"></i>View
                                    </a>
                                        <a href="{{ route('community.edit', $community->id) }}" class="px-3 py-1 inline-flex items-center text-sm mr-2 rounded" style="background-color:#6b7280;color:#ffffff;border:1px solid rgba(0,0,0,0.06);box-shadow:0 1px 2px rgba(0,0,0,0.04);">
                                        <i class="fas fa-edit mr-1"></i>Edit
                                    </a>
                                        <button wire:click.prevent="confirmDelete('{{ $community->id }}')" class="px-3 py-1 inline-flex items-center text-sm rounded" style="background-color:#dc2626;color:#ffffff;border:1px solid rgba(0,0,0,0.06);box-shadow:0 1px 2px rgba(0,0,0,0.04);">
        ...
        @else
            <div class="text-center py-12">
                ...
                <a href="{{ route('community.create') }}" class="px-4 py-2 inline-block rounded shadow" style="background-color:#2563eb;color:#ffffff;border:1px solid rgba(0,0,0,0.05);">
