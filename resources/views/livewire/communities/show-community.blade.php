        ...
        <div class="p-6 bg-gray-50 border-b">
            <div class="flex justify-between items-center">
                ...
                @if(auth()->check() && auth()->user()->can('update', $community))
                    <a href="{{ route('community.edit', $community->id) }}" class="inline-flex items-center px-4 py-2 rounded-md shadow-sm text-sm font-medium" style="background-color:#4f46e5;color:#ffffff;border:1px solid rgba(0,0,0,0.05);">
                        Edit Community
                    </a>
                @endif
            </div>
                        ...
                        <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="mt-2 sm:mt-0 sm:ml-4">
                                    <a href="{{ route('events.show', $event->id) }}" class="inline-flex items-center px-3 py-1.5 rounded-md text-sm font-medium" style="background-color:#ffffff;color:#111827;border:1px solid rgba(0,0,0,0.06);box-shadow:0 1px 2px rgba(0,0,0,0.04);">
                                        View Details
                                    </a>
                                </div>
                            </div>
