  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 
    ...
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('') }}" target="_blank">
        ...
        <span
          class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">Atlas
          Roads</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <div
              class="{{ (Request::is('books*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                  ...
                  <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(153.000000, 2.000000)">
                        <path class="{{ (Request::is('books*') ? '' : 'fill-slate-800') }}"
                          d="M21,0 C17.6862915,0 15,2.68629150 15,6 L15,36 C15,39.3137085 17.6862915,42 21,42 L39,42 C40.1045695,42 41,41.1045695 41,40 L41,2 C41,0.8954305 40.1045695,0 39,0 L21,0 Z M21,4 L37,4 L37,38 L21,38 C19.8954305,38 19,37.1045695 19,36 L19,6 C19,4.8954305 19.8954305,4 21,4 Z">
                        </path>
                        <path class="{{ (Request::is('books*') ? '' : 'fill-slate-800') }}" opacity="0.598981585"
                          d="M3,6 C3,2.6862915 5.6862915,0 9,0 L15,0 L15,6 C15,2.6862915 12.3137085,0 9,0 C5.6862915,0 3,2.6862915 3,6 L3,36 C3,39.3137085 5.6862915,42 9,42 L15,42 L15,36 C15,39.3137085 12.3137085,42 9,42 C5.6862915,42 3,39.3137085 3,36 L3,6 Z">
                        </path>
                        <path class="{{ (Request::is('books*') ? '' : 'fill-slate-800') }}"
                          d="M1,6 C1,3.790861 2.790861,2 5,2 L9,2 C11.209139,2 13,3.790861 13,6 L13,36 C13,38.209139 11.209139,40 9,40 L5,40 C2.790861,40 1,38.209139 1,36 L1,6 Z">
                        </path>
                      </g>
                    </g>
                  </g>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <div class="{{ (Request::is('events') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('wishlist*') && !Request::is('admin/wishlist*') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('wishlist') }}">

            <div
              class="{{ (Request::is('wishlist*') && !Request::is('admin/wishlist*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-heart ps-2 pe-2 text-center {{ (Request::is('wishlist*') && !Request::is('admin/wishlist*') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">My Wishlist</span>
          </a>
        </li>
           <li class="mt-0.5 w-full">
  <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
      {{ (Request::is('clubs*') && !Request::is('admin/clubs*') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
     href="{{ url('clubs') }}">

    <div
      class="{{ (Request::is('clubs*') && !Request::is('admin/clubs*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

      <i style="font-size: 1rem;"
         class="fas fa-users ps-2 pe-2 text-center {{ (Request::is('clubs*') && !Request::is('admin/clubs*') ? 'text-white' : 'text-dark') }}"
         aria-hidden="true"></i>
...
<li class="mt-0.5 w-full">
  <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
      {{ (Request::is('meetings*') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
     href="{{ url('meetings') }}">

    <div
      class="{{ (Request::is('meetings*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

      <i style="font-size: 1rem;"
         class="fas fa-calendar-alt ps-2 pe-2 text-center {{ (Request::is('meetings*') ? 'text-white' : 'text-dark') }}"
         aria-hidden="true"></i>
...
<li class="mt-0.5 w-full">
  <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
      {{ (Request::is('admin/club-memberships*') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
     href="{{ route('admin.club-memberships.index') }}">

    <div
      class="{{ (Request::is('admin/club-memberships*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

      <i style="font-size: 1rem;"
         class="fas fa-user-plus ps-2 pe-2 text-center {{ (Request::is('admin/club-memberships*') ? 'text-white' : 'text-dark') }}"
         aria-hidden="true"></i>
...
@endif
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              {{ (Request::is('admin/wishlist*') ? 'shadow-soft-xl rounded-lg bg-white font-semibold text-slate-700' : '') }}"
            href="{{ url('admin/wishlist') }}">

            <div
              class="{{ (Request::is('admin/wishlist*') ? ' bg-gradient-fuchsia' : '') }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">

              <i style="font-size: 1rem;"
                class="fas fa-tasks ps-2 pe-2 text-center {{ (Request::is('admin/wishlist*') ? 'text-white' : 'text-dark') }} "
                aria-hidden="true"></i>

            </div>
            <span
              class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Manage Wishlist</span>
          </a>
        </li>
