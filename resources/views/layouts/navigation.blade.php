            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        ...
                        <x-nav-link :href="route('reclamations.chatbot')" :active="request()->routeIs('reclamations.chatbot*')">
                            🤖 {{ __('AI Assistant') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                <x-responsive-nav-link :href="route('reclamations.chatbot')" :active="request()->routeIs('reclamations.chatbot*')">
                    🤖 {{ __('AI Assistant') }}
                </x-responsive-nav-link>
